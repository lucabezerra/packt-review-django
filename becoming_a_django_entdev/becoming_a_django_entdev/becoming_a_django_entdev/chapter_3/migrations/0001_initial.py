...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['name'], name='chapter_3_v_name_055414_idx'),
        ),
        migrations.AddIndex(
            model_name='vehicle_model',
        ...
        migrations.AddField(
            model_name='vehicle',
            name='engine',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vehicle_engine', to='chapter_3.engine', verbose_name='Engine'),
        ),
        migrations.AddField(
            model_name='vehicle',
            name='vehicle_model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vehicle_model', to='chapter_3.vehicle_model', verbose_name='Model'),
        ),
        migrations.AddField(
            model_name='engine3',
            name='vehicle_model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='engine2_model', to='chapter_3.vehicle_model', verbose_name='Model'),
        ),
        migrations.AddField(
            model_name='seller',
            name='groups',
        ...
        migrations.AddField(
            model_name='seller',
            name='vehicle',
            field=models.ManyToManyField(blank=True, related_name='vehicles', related_query_name='vehicle', to='chapter_3.Vehicle', verbose_name='Vehicles'),
        ),
    ]
